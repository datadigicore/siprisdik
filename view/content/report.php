      ...
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs nav-justified">
          ...
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
              Kuitansi Lain-lain <span class="caret"></span>
            </a>
        ...
        <div class="tab-content" style="padding:5px 0 0 0;">
          <div class="tab-pane active" id="tab_1">
            <form method="POST" action="<?php echo $url_rewrite;?>process/report/kuitansi">
          ...
          <div class="tab-pane" id="tab_2">
            <form method="POST" action="<?php echo $url_rewrite;?>process/report/table">
            <div class="box-body" style="padding-bottom:0;">
              <div class="form-group">
                <input type="text" name="tgl_awal" class="form-control" id="tgl_awal" placeholder="Tanggal Awal">
              </div>
